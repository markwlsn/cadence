...
async function testWorkerFix2() {
  ...
  console.log('WorkerMessageHandler set on globalThis:', typeof (globalThis as any).pdfjsWorker.WorkerMessageHandler);
...
testWorkerFix2().catch(console.error);
