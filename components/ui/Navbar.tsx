      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Link
            ...
            className="w-9 h-9 rounded-full flex items-center justify-center overflow-hidden bg-[var(--color-surface)] border border-[var(--color-border)] hover:border-[var(--color-border-strong)] transition-colors shrink-0 font-semibold text-[var(--color-text-secondary)] text-[15px]"
          >
            {mounted && isEmoji ? (
          ...
          <button
            ...
            className="md:hidden w-9 h-9 rounded-full flex items-center justify-center text-[var(--color-text-secondary)] hover:text-[var(--color-text)] hover:bg-[var(--color-surface-overlay)] transition-colors"
          >
            {mobileOpen ? (
